...
fn main() {
    ...
    Report::build(ReportKind::Error, "stresstest.tao", 13)
        ...
        .with_label(Label::new(("stresstest.tao", 21..22)).with_message("Color").with_color(colors.next()))
        .with_label(Label::new(("stresstest.tao", 22..23)).with_message("Color").with_color(colors.next()))
        ...
        .with_label(Label::new(("stresstest.tao", 55..78)).with_message("This is of type Str").with_color(colors.next()))
        .with_label(Label::new(("stresstest.tao", 81..134)).with_message("This is of type Nat").with_color(colors.next()))
        ...
        .with_label(Label::new(("stresstest.tao", 23..100)).with_message("Hahaha!").with_color(Color::Fixed(75)))
